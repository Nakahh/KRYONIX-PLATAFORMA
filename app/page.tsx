...
export default function HomePage() {
  ...
  const modules = [
    { name: 'Análise Avançada e BI', price: 'R$ 99/mês', status: 'unavailable' },
    { name: 'Agendamento Inteligente', price: 'R$ 119/mês', status: 'unavailable' },
    { name: 'Atendimento Omnichannel', price: 'R$ 159/mês', status: 'unavailable' },
    { name: 'CRM & Funil de Vendas', price: 'R$ 179/mês', status: 'unavailable' },
    { name: 'Email Marketing Multicanal', price: 'R$ 219/mês', status: 'unavailable' },
    { name: 'Gestão Redes Sociais', price: 'R$ 239/mês', status: 'unavailable' },
    { name: 'Portal do Cliente', price: 'R$ 269/mês', status: 'unavailable' },
    { name: 'Whitelabel Customizável', price: 'R$ 299/mês', status: 'unavailable' }
  ]
