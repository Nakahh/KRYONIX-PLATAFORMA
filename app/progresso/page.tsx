              ...
              <div className="flex items-center justify-center space-x-6">
                ...
                >
                  <div className="relative">
                    <div className="w-12 h-12 rounded-2xl flex items-center justify-center transition-all duration-300 transform bg-green-50 text-[#25D366] group-hover:bg-[#25D366] group-hover:text-white group-hover:scale-105 group-hover:shadow-xl group-hover:shadow-green-500/25">
                      <svg
                        className="w-6 h-6"
                        viewBox="0 0 24 24"
                        fill="currentColor"
                    ...
                    <div className="absolute -bottom-1 -right-1 w-3 h-3 bg-[#25D366] rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300 animate-pulse"></div>
                  </div>
                </a>
                <a
                ...
                >
                  <div className="relative">
                    <div className="w-12 h-12 rounded-2xl flex items-center justify-center transition-all duration-300 transform bg-blue-50 text-blue-500 group-hover:bg-blue-500 group-hover:text-white group-hover:scale-105 group-hover:shadow-xl group-hover:shadow-blue-500/25">
                      <svg
                        className="w-6 h-6"
                        viewBox="0 0 24 24"
                        fill="none"
                ...
                >
                  <div className="relative">
                    <div className="w-12 h-12 rounded-2xl flex items-center justify-center transition-all duration-300 transform bg-gradient-to-br from-purple-50 via-pink-50 to-orange-50 text-purple-600 group-hover:from-purple-500 group-hover:via-pink-500 group-hover:to-orange-400 group-hover:text-white group-hover:scale-105 group-hover:shadow-xl group-hover:shadow-purple-500/25">
                      <svg
                        className="w-6 h-6"
                        viewBox="0 0 24 24"
                        fill="currentColor"
