...
import { ArrowLeft, Users, Target, Zap, CheckCircle, Clock, TrendingUp, Award } from 'lucide-react'
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center justify-center w-16 h-16 bg-purple-100 dark:bg-purple-900/20 rounded-2xl mb-8">
            ...
            <div className="text-3xl font-bold text-purple-600 mb-4">R$ 179/mês</div>
            
            <p className="text-xl text-gray-600 dark:text-gray-300 mb-8 max-w-2xl mx-auto">
              Gerencie seus clientes e vendas com inteligência artificial que nunca perde uma oportunidade.
            </p>
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-2xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href="https://wa.me/5517981805327?text=Olá! Tenho interesse no módulo: CRM & Funil de Vendas (R$ 179/mês). Gostaria de mais informações."
                target="_blank"
              ...
              <Link 
                href="/"
                className="bg-transparent border border-white text-white px-8 py-3 rounded-lg font-medium hover:bg-white hover:text-purple-600 transition-colors"
              >
                Ver Outros Módulos
              </Link>
            </div>
